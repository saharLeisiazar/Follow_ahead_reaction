        ...
        while tid0 < e-horizon:
            ...
            if len(idx):
                ...
                for i in range(len(idx)):
                    ...
                    # ######## Add print statements to print the points in each trajectory
                    # print(f"Trajectory {len(traj)}:")
                    # print(f"Observation Points (hist): {hist}")
                    # print(f"Future Points (future): {future}")
                    # print(f"Neighbor Points (neighbor): {neighbor}")
                    # print("\n")
            tid0 += 1
